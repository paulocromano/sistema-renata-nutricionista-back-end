...
@Getter
public class InformacoesCadastroQuestionarioDTO {
	...
	public InformacoesCadastroQuestionarioDTO(List<AlimentoFrequenciaAlimentar> alimentosFrequenciaAlimentar) {
